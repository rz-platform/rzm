...
import models.{Account, AccountLoginData, AccountRegistrationData, AccountRepository, Repository}
...
class UserRequest[A](request: Request[A], val account: Account, val messagesApi: MessagesApi) extends WrappedRequest[A](request) with UserRequestHeader
...
class RepositoryRequest[A](request: UserRequest[A], val repository: Repository, val owner: Account, val account: Account, val messagesApi: MessagesApi) extends WrappedRequest[A](request)  with RepositoryRequestHeader
